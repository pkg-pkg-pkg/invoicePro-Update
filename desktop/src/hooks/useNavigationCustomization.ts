...
const DEFAULT_MENU_ITEMS: (MenuItem | MenuGroup)[] = [
  ...
  },
  {
    ...
    enabled: true,
    items: [
      { id: 'sales-vouchers', text: 'Sales Vouchers', icon: 'Receipt', path: '/vouchers/sales', enabled: true },
      { id: 'sales-return-vouchers', text: 'Sales Return Vouchers', icon: 'Undo', path: '/vouchers/sales-return', enabled: true },
      { id: 'purchase-vouchers', text: 'Purchase Vouchers', icon: 'ShoppingCart', path: '/vouchers/purchase', enabled: true },
      { id: 'purchase-return-vouchers', text: 'Purchase Return Vouchers', icon: 'Redo', path: '/vouchers/purchase-return', enabled: true },
      { id: 'payment-vouchers', text: 'Payment Vouchers', icon: 'Payment', path: '/vouchers/payment-vouchers', enabled: true },
      { id: 'receipt-vouchers', text: 'Receipt Vouchers', icon: 'Receipt', path: '/vouchers/receipt-vouchers', enabled: true },
      { id: 'journal-vouchers', text: 'Journal Vouchers', icon: 'AccountBalance', path: '/vouchers/journal', enabled: true },
    ],
  },
