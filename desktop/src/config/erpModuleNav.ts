...
export const ERP_PRIMARY_MODULES: ErpModuleNavItem[] = [
  ...
  { id: 'parties', label: 'Customers', icon: 'People', path: '/customers', matchPaths: ['/customers', '/parties'] },
  {
    id: 'purchase',
    label: 'Purchase',
    icon: 'ShoppingCart',
  ...
  { id: 'reports', label: 'Reports', icon: 'Assessment', path: '/reports', matchPaths: ['/reports'] },
...
export const QUICK_ADD_ACTIONS: QuickAddAction[] = [
  ...
  { id: 'purchase', label: 'Purchase Bill', hint: 'Supplier purchase entry', path: '/vouchers/purchase/new', perm: 'create-vouchers' },
  ...
  { id: 'new-item', label: 'New Item', hint: 'Inventory master', path: '/masters/inventory-items/new', perm: 'manage-inventory' },
  ...
  { id: 'new-party', label: 'New Customer', hint: 'Customer master', path: '/customers?new=1' },
];
